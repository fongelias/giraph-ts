...
describe('WeightedUndirectedGraph', () => {
  ...
  describe('#addEdge', () => {
    ...
    it('should add throw an error when one or more of the verticies do not exist', () => {
      ...
      expect(() => graph.addEdge(defaultVertex, nonExistentVertex, defaultWeight)).toThrow();
    });
  });
  ...
  describe('#neighbors', () => {
    it('should return an array of neighbors from the vertex', () => {
      ...
      // add edges
      graph.addEdge(defaultVertex, firstDestination, defaultWeight);
      graph.addEdge(defaultVertex, secondDestination, defaultWeight);
      // verify neighbors
  ...
  describe('#edgesFrom', () => {
    it('should return an array of edges from the vertex', () => {
      ...
      graph.addEdge(defaultVertex, secondDestination, defaultWeight);
      // verify edges
      const firstExpectedEdge = new WeightedDirectedEdge<string, number>(defaultVertex, firstDestination, defaultWeight);
      const secondExpectedEdge = new WeightedDirectedEdge<string, number>(defaultVertex, secondDestination, defaultWeight);
